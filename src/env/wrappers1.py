...
class ColorWrapper(gym.Wrapper):
	...
	def _load_colors(self):
		...
		self._colors = torch.load(f'/mnt/lustre/GPU4/home/wuhanpeng/SCPL/src/env/data/{self._mode}.pt')
...
class VideoWrapper(gym.Wrapper):
	...
	def _get_video_paths(self):
		video_dir = os.path.join('/mnt/lustre/GPU4/home/wuhanpeng/SCPL/src/env/data', self._mode)
